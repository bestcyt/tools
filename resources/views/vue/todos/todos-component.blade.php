    ...
    <div class="col-md-5">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <todo-items-form v-bind:todos="todos"></todo-items-form>
            </div>
        </div>
    </div>
</div>
...
<script type="text/x-template" id="todo-items-form-template">
...
<script>
    ...
    Vue.component('todo-items-form',{
        template:'#todo-items-form-template',
        props:['todos'],
        methods:{
            additem(newitem){
